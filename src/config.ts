...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				"这里是NuoYan，欢迎来到我的个人空间。",
				"记录一些学习的知识，分享一些生活的点滴。",
				"Strive for the best, and stay away from the worst.",
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/immortal5205",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/498740768?spm_id_from=333.1007.0.0",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/NuoYanRuoShui",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/waguri.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "诺言若水",
	bio: "一人一心一旧城，旧街旧巷等旧人。",
	links: [
		{
